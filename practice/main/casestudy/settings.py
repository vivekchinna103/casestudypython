...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'casestudy.context_processors.context'
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        'ENGINE': 'mssql',
        "NAME": os.getenv("DB_NAME"),   #"DL-practice"
        "USER":os.getenv("DB_USER"),
        "PASSWORD":os.getenv("DB_PASSWORD"),  
        "HOST": os.getenv("DB_SERVER"), #"dlpractice.database.windows.net"
